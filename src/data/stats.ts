...
export const stats: Stat[] = [
  ...
  { value: 4, suffix: "+", label: "AI Tools Utilized" },
];

export const aboutParagraphs: string[] = [
  "I'm a Computer Science graduate from ACLC College of Sta. Maria and a full-stack web developer with over 4 years of hands-on experience building websites and business applications.",
